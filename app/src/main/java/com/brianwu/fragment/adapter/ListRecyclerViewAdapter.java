...
//    private final DisplayImageOptions options;
    ...
    public ListRecyclerViewAdapter(Context context , List<HitBean> items, OnListFragmentInteractionListener listener ) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mTitleView.setText(mContext.getString(R.string.txt_user) + holder.mItem.getUser());
